	...
	struct asm_mnemonic_symbols : x3::symbols<elang::easm::instruction::id>{
		asm_mnemonic_symbols(){
			add
				...
				("setz", elang::easm::instruction::id::setz)
				("setnz", elang::easm::instruction::id::setnz)
				("sete", elang::easm::instruction::id::sete)
				("setne", elang::easm::instruction::id::setne)
				("setle", elang::easm::instruction::id::setle)
				("setl", elang::easm::instruction::id::setl)
				("setnle", elang::easm::instruction::id::setnle)
				("setnl", elang::easm::instruction::id::setnl)
				("setge", elang::easm::instruction::id::setge)
				("setg", elang::easm::instruction::id::setg)
				("setnge", elang::easm::instruction::id::setnge)
				("setng", elang::easm::instruction::id::setng)
